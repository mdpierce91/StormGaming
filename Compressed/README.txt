...
4. in one terminal type: python bmpudprecieve.py
5. in the other terminal type: python udpbmpsend.py [number of frames you want to send] without the [], if you don't give a number then a default of 1 will be used, example: python udpbmpsend.py 60
